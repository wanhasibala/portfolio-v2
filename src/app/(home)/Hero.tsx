...
const Hero = () => {
  return (
    ...
    <div className="absolute  left-[50%] translate-x-[-50%] ">
      ...
      {/* hero section */}
      <div className=" mt-[160px] z-10  h-[60vh] flex flex-col justify-between w-full ">
        {/* Hero text */}
        <div className="flex flex-col dark:bg-[#171717] dark:bg-opacity-30 bg-[#f8f8f8] bg-opacity-30 p-2.5 rounded-[20px] backdrop-blur-xl ">
            ...
            <p className="text-xl mt-10  md:max-w-[600px]">Empowering online entrepreneurs to craft standout products with innovative design and strategic development. Let&apos;s create something remarkable together.</p>
      </div>
    </section>
  );
};
