...
import { ArrowUpRight, Shield, Activity, Cpu } from "lucide-react";
...
const Hero = () => {
  ...
  const verticalContent = {
    general: {
      ...
      description: "I am Wan Hasib Al Aslamy, a Frontend Engineer & UI Architect. I specialize in maximizing client-side performance, reducing time-to-interactive, and establishing strict design-to-code pipelines.",
      techStack: [
        { category: "Core Architecture", skills: ["React", "Next.js (App Router)", "TypeScript"] },
        { category: "State & Performance", skills: ["Zustand", "React Query", "Web Workers"] },
        { category: "Interface & Motion", skills: ["Tailwind CSS", "GSAP", "Framer Motion"] },
      ],
      metrics: [
        {
          value: "-45%",
    ...
    fintech: {
      ...
      description: "I am Wan Hasib Al Aslamy, a Financial Platform Architect. I specialize in mathematically precise rendering pipelines, memory-cached local state models, and high-frequency transaction dashboards.",
      techStack: [
        { category: "Precision & Core", skills: ["React", "TypeScript", "Math.js"] },
        { category: "Data Hydration", skills: ["Context API", "RTK Query", "Web Workers"] },
        { category: "Display Layer", skills: ["Tailwind CSS", "ChartJS", "HTML Canvas"] },
      ],
      metrics: [
        {
          value: "0.00%",
    ...
    web3: {
      ...
      description: "I am Wan Hasib Al Aslamy, a Web3 UX Engineer. I specialize in real-time asynchronous WebSockets streams, optimized component repaint scopes, and smooth animations.",
      techStack: [
        { category: "Decentralized Integration", skills: ["Next.js", "TypeScript", "Ethers.js"] },
        { category: "Real-time State", skills: ["Zustand", "SWR", "WebSocket Engine"] },
        { category: "Interface Performance", skills: ["Tailwind CSS", "GSAP", "WebGL"] },
      ],
      metrics: [
        {
          value: "60 FPS",
  ...
  return (
    <section className="min-h-screen w-full flex flex-col justify-center items-center px-6 md:px-12 lg:px-20 pt-32 pb-16 bg-white dark:bg-[#0A0A0A] text-black dark:text-white transition-colors duration-300">
      <motion.div
