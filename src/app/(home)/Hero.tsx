...
const Hero = () => {
  return (
    ...
    <div className="absolute  left-[50%] translate-x-[-50%] ">
      ...
      {/* hero section */}
<<<<<<< HEAD
      <div className=" mt-[160px] z-8  h-[60vh] flex flex-col justify-between w-full ">
=======
...
>>>>>>> refs/remotes/origin/main
        ...
        <div className="flex flex-col dark:bg-[#171717] dark:bg-opacity-30 bg-[#f8f8f8] bg-opacity-30 p-2.5 rounded-[20px] backdrop-blur-xl z-2">
            ...
            <p className="text-xl mt-10 z-2 md:max-w-[600px]">Empowering online entrepreneurs to craft standout products with innovative design and strategic development. Let&apos;s create something remarkable together.</p>
      </div>
    </section>
  );
};
